...
public final class DashboardView extends Panel implements View,
	...
	public static final String DATASOURCE_ID = "dashboard-datasource";
...
//        sparks.addComponent(s);
    ...
    private Component buildAddDataSourceButton() {
        Button result = new Button();
        result.setId(DATASOURCE_ID);
        result.setIcon(FontAwesome.ARCHIVE);
        result.addStyleName("icon-edit");
        result.addStyleName(ValoTheme.BUTTON_ICON_ONLY);
        result.setDescription("Add Datasource");

        result.addClickListener(new ClickListener() {
            @Override
            public void buttonClick(final ClickEvent event) {
                getUI().addWindow(
                        new DashboardAddDatasource(DashboardView.this, titleLabel
                                .getValue()));
            }
        });
        return result;
